...
test_that("labels are generated properly", {
  expect_identical(
    ...
    data.frame(label = c("example001", "example002"), ind_string = c("example", "example"), ind_number = c("001", "002"), stringsAsFactors = FALSE))
  expect_identical(
    uniqID_maker(string="example", level=c(3,1)), 
    data.frame(label = c("example003", "example001"), ind_string = c("example", "example"), ind_number = c("003", "001"), stringsAsFactors = FALSE))
  expect_identical(
    uniqID_maker(string = "example", level = 1:2, ending_string = "end"),
    data.frame(label = c("example001-end", "example002-end"), ind_string = c("example", "example"), ind_number = c("001", "002"), end_string = c("end", "end"), stringsAsFactors = FALSE)
  )
  expect_identical(
    uniqID_maker(string="example", level=1:2, digits = 1), 
    data.frame(label = c("example1", "example2"), ind_string = c("example", "example"), ind_number = c("1", "2"), stringsAsFactors = FALSE))
