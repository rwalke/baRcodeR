...
#'
#' @return a data frame with text labels in the first column, and separated string
#' and number values in two different columns.
#' @param user logical. Default is FALSE. Should the function run with user prompts. When \code{user = F}, the user has to specify at least \code{string} and \code{level}.
