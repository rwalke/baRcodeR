...
## 0.5"x1.75" Worth Poly Label WP0517 (Polyester Label Stock); 
# And Staples 80-label sheet (For other formats you can change the pdf and par settings below
...
## Worth Data inc 80-label sheet
Comi<-c(0.511811,0.275591,0.511811,0) # Custom outer margin, in inches
Cmai<-c(0.0787402,0.0787402,0.0787402,0.3937012) # Custom inner margin (i.e. individual label), in inches

## Staples 80-label sheet
#Comi<-c(0.492126,0.2952756,0.492126,0) # Custom outer margin, in inches
#Cmai<-c(0.0787402,0.19685,0.0787402,0.19685) # Custom inner margin (i.e. individual label), in inches


# this is now imported in sysdata.rda
...
## this part is own function, just like the qrcode one, function will not be exported, ie binary_make
...
par(mfrow=c(20,4),omi=Comi,mai=Cmai,lend="square",lmitre=1) # Set up output
